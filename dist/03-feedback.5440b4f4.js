...
formRef.addEventListener("input", (0, _lodashThrottleDefault.default)(addLocalStorage, 500));
...
function insertWithLS(object) {
    ...
    if (object && messageInput.name === "message") inputValue.message = JSON.parse(object).message;
