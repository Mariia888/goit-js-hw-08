...
const galleryMarkup = (0, _galleryItems.galleryItems).map(({ preview , original , description  })=>`<a class = "gallery__link" href =${original}><img class = "gallery__image" src="${preview}" alt="${description}"></a>`).join("");
